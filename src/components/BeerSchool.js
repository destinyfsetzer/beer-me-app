  ...
  return (
    ...
    >
      <div className="beer-school">
        ...
        <ul>
          <li>All stouts are heavy beers that will make you fat and lonely</li>
          <li>Lagers are all boring blonde piss-water</li>
          <li> Hoppy = bitter</li>
          <li>Wheat beers all taste like banana</li>
          <li>
            All commercial beers are the golden standard of a beer style and all
            other beers should be measured up to these beer ( Could not be more
            wrong )
          </li>
        </ul>
        <img
          ...
          alt="beer banner"
          src="https://i.ibb.co/mFQXppR/beeeeeeer.jpg"
        />
        <h2>THE TASTE OF BEER</h2>
        <p>
          Now that your have emptied out some space in your brain you have room
          for some new information. For starters, there are three common
        ...
        <p>
          <b>Hops</b> - flower closely related to weed that is soaked in beer to
          produce citrus, tropical, herbal, piney, dank, earthy, and floral
        ...
        <p>
          ...
          contributes grainy flavors like water crackers, bread, toast, caramel,
          dark fruit, chocolate, coffee, etc. Malt is the term for barley that
          is specially prepared for use in the brewhouse.
        </p>
        <h2>SOME KEY BEER TERMS</h2>
        <p>
          In addition to the common ingredients, there are a few other key terms
          you may encounter while perusing a beer menu that are worth knowing:
          ABV, Imperial and IBUs.
        </p>
        <p>
          <b>ABV</b> - Alcohol by volume. Usually listed as a percentage so you
          know how strong a beer is.
        </p>
        <p>
          <b>Imperial</b> - This is used in the name of beers with an abv >7.5%.
          Basically beers that are strong as heck and will knock you off your
          barstool!
        </p>
        <p>
        ...
        <p>
          ...
          relatively short period of time (3-5 weeks). On the other hand, lagers
          take much longer to ferment (up to 6 to 8 weeks) because they are cold
          fermented.
        </p>
        <img
          className="beer-header"
        ...
        <p>
          ...
          fermentation technique and yeast used in brewing. While taste does not
          necessarily determine the style, there are some general distinctions:
        </p>
        <ul>
          <li>
          ...
          <li>
            Ales tend to be more full-bodied, sweeter and fruity in taste. This
            has to do with the fermentation processes. The faster, more
